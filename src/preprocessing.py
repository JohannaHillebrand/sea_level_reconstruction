...
def change_clustering_resolution(sea_level_data: xarray.Dataset, clustering_data: xarray.Dataset):
    """
    ...
    :return:
    """
    if not os.path.exists("../data/clustering/clustering_15_025_resolution.nc"):
        ...
        fine_resolution_clusters.to_netcdf("../data/clustering/clustering_15_025_resolution.nc")
        ...
        fine_resolution_clusters = xarray.open_dataset("../data/clustering/clustering_15_025_resolution.nc")

    # plot clustering before and after regridding
    plotting.plot_xarray_dataset_on_map(clustering_data, "../output/plots", "clustering_before_regridding")
    plotting.plot_xarray_dataset_on_map(fine_resolution_clusters, "../output/plots", "clustering_after_regridding")
...
def read_data(global_settings: GlobalSettings) -> tuple[
    ...
    cluster_id_to_lat_lon_pairs, cluster_id_to_grid_point_id = extract_clusters_from_xarray_dataset(
        fine_resolution_clustering_data)
...
def extract_clusters_from_xarray_dataset(clustering_data: xarray.Dataset):
    ...
    :return:
    """
    if not (os.path.exists("../data/clustering/cluster_id_to_lat_lon_pairs.pkl") and os.path.exists(
            "../data/clustering/cluster_id_to_grid_point_id.pkl")):
        ...
        pickle.dump(cluster_id_to_lat_lon_pairs, open("../data/clustering/cluster_id_to_lat_lon_pairs.pkl", "wb"))
        pickle.dump(cluster_id_to_grid_point_id, open("../data/clustering/cluster_id_to_grid_point_id.pkl", "wb"))
    else:
        cluster_id_to_lat_lon_pairs = pickle.load(open("../data/clustering/cluster_id_to_lat_lon_pairs.pkl", "rb"))
        cluster_id_to_grid_point_id = pickle.load(open("../data/clustering/cluster_id_to_grid_point_id.pkl", "rb"))
